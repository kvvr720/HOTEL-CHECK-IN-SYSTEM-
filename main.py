...
# cur.execute("insert into paymentsf values(1,'IT-14','Khare','9589861196','IT-147673@gmail.com',2,'1','05','2023','11:20:27 PM','Cash','3500')")
...
spath = "images/newman.jpg"
simg = ImageTk.PhotoImage(Image.open(spath))
my = Label(sroot, image=simg)
my.image = simg
my.place(x=100, y=100)
Frame(sroot, height=516, width=5, bg='black').place(x=520, y=0)
# chilanka
Label(sroot, text="HAPPY STAYS ", font='Times 60 italic bold ', bg='white', fg='black').place(x=535, y=10)
Label(sroot, text="Made by- IT-14", font='Timesnewroman 40 ', bg='white', fg='black').place(x=535, y=90)
Label(sroot, text="developer@mru.ac.in", font='Timesnewroman 30', bg='white', fg='black').place(x=535, y=180)


# Label(sroot,text="xxxx",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=450)
# ----------- main project------------------------------------------------------------------------------------------------------------------
def mainroot():
    # sroot.destroy()
    root = Tk()
    ...
    root.title("Made with love by IT-14" )
    # --------------seperator-------------------------------------------------------------------------------------------------------------------
    ...
    tf_label = Label(top_frame, text='HAPPY STAYS', font='Times 40 italic bold', fg='black', bg='gray89', height=70)
    ...
    def hotel_status():
        ...
        # -----------------------------------------------------------------
        nl = Label(b_frame, text='Made by IT-14', fg='black', bg='gray91', font='msserif 8')
    ...
    def staff():
        ...
        Label(emp1inf, text="Mr.VISHNU", bg='white', fg="Grey", font='msserif 10').place(x=60, y=37)
        Label(emp1inf, text="Extention : 025", bg='white', fg="Grey", font='msserif 10').place(x=60, y=59)
        Label(emp1inf, text="Mail : manager@happystays.ac.in", bg='white', fg="Grey", font='msserif 10').place(x=60, y=83)
        ...
        Label(emp1inf, text="Reception", bg='white', font='msserif 17 bold').place(x=45,y=0)  # pack(side='top')
        Label(emp1inf, text="Mr.ROHITH", bg='white', fg="Grey", font='msserif 10').place(x=45, y=37)
        Label(emp1inf, text="Extention : 032", bg='white', fg="Grey", font='msserif 10').place(x=45,y=59)
        Label(emp1inf, text="Mail : reception@happystays.ac.in", bg='white', fg="Grey", font='msserif 10').place(x=45, y=83)
        emp1inf.pack_propagate(False)
        ...
        Label(emp1inf, text="Mr.SUMANTH (Head)", bg='white', fg="Grey", font='msserif 10').place(x=72, y=37)
        Label(emp1inf, text="Extention : 028", bg='white', fg="Grey", font='msserif 10').place(x=72, y=59)
        Label(emp1inf, text="Mail : restaurant@happystays.ac.in", bg='white', fg="Grey", font='msserif 10').place(x=72,y=83)
        emp1inf.pack_propagate(False)
        emp1inf.place(x=99, y=153)
        emp1inf.tkraise()

        emp1f = Frame(b_frame)
        path4 = "images/managementhead.jpg"
        ...
        Label(emp1inf, text="Management Head", bg='white', font='msserif 17 bold').place(x=55, y=0)  # pack(side='top')
        Label(emp1inf, text="Ms.MEENAKSHI (Head)", bg='white', fg="Grey", font='msserif 10').place(x=55, y=37)
        Label(emp1inf, text="Extention : 041", bg='white', fg="Grey", font='msserif 10').place(x=55, y=59)
        Label(emp1inf, text="Mail : managementhead@happystays.ac.in", bg='white', fg="Grey", font='msserif 10').place(x=55,y=83)
        emp1inf.pack_propagate(False)
    ...
    def rooms():
        ...
        def roomdet(rno):
            ...
            smf2 = Frame(b_frame, height=120, width=145, bg='white')
            tr = Label(smf2, text='  Travel guide ?', fg='white', bg='cyan4', width=100, height=2, font='msserif 15')
            tr.pack(side='top')
            smf2.pack_propagate(False)
    ...
    def reserve():
        ...
        # --------------------------------------------------------right side---------------------------------------------------
        Label(b_frame, text='Filter', font='msserif 15', bg='gray93').place(x=850, y=0)
        ...
        Label(b_frame, text='T Guide:', font='10', bg='gray93').place(x=732, y=125)
        # Radiobutton(b_frame,text='Yes',bg='gray93',variable=tvb,value=1,font='15',width=3).place(x=800,y=130)
        # Radiobutton(b_frame,text='No',bg='gray93',variable=tvb,value=0,font='15',width=3).place(x=880,y=130)
        TravelGuide = ttk.Combobox(b_frame, values=['please select...', 'Yes', 'No'], state='readonly', width=22)
        TravelGuide.place(x=830, y=125)
        TravelGuide.current(0)
        ...
        def findrooms():
            cur.execute(
                ...
                ((nb.get()), ac.get(), tv.get(), TravelGuide.get()))
            x = cur.fetchall()
            # print (x)
